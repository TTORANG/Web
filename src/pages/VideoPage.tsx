    ...
    <div className="h-full w-full bg-gray-100 overflow-hidden">
      ...
      {step === 'TEST' && (
        <div className="fixed inset-0 z-[100] bg-[#1a1a1a] flex flex-col overflow-hidden">
          {/* 다크 헤더 */}
          <header className="h-15 px-18 flex items-center justify-between border-b border-white/10 bg-[#2a2d34] shrink-0">
            <div className="flex items-center gap-4">
              <div className="flex items-center brightness-200 contrast-150">
                <Logo />
              </div>
