        ...
        <div
          className={clsx(
            ...
            showPip
              ...
              : 'inset-0',
            !showPip && (isSlideMain ? 'z-10' : 'z-0 opacity-0 pointer-events-none'),
          )}
        >
          <img
            ...
            className={clsx(
              'h-full w-full',
              showPip ? (isSlideMain ? 'object-contain' : 'object-cover') : 'object-contain', // 작은 박스일 땐 꽉 차게(보기 좋게)
            )}
            draggable={false}
          />
        ...
        <div
          className={clsx(
            ...
            showPip
              ...
              : 'inset-0',
            !showPip && (isSlideMain ? 'z-0 opacity-0 pointer-events-none' : 'z-10'),
          )}
        >
          <video
            ref={videoRef}
