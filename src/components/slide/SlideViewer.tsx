...
export default function SlideViewer({ isScriptCollapsed, isLoading }: SlideViewerProps) {
    ...
    <section className="flex flex-1 min-h-0 flex-col justify-center overflow-hidden">
      <div className="mx-auto w-full" style={{ maxWidth: SLIDE_MAX_WIDTH }}>
        <div
          ...
          style={{
            transform: `translateY(${!isLoading && isScriptCollapsed ? SLIDE_COLLAPSED_OFFSET : 0}px)`,
          }}
        >
