...
export const videosApi = {
  ...
  // POST /videos/{videoId}/comments - 비디오에 댓글 작성
  createComment: (videoId: number, data: { content: string; timestampMs?: number }) =>
    apiClient.post(`/videos/${videoId}/comments`, data),

  // POST /comments/{commentId}/replies - 댓글에 답글 작성
