...
export const getMockProjectAnalyticsSummary = (projectId: string): ProjectAnalyticsSummaryDto => {
  return {
...
export const getMockVideoExitAnalytics = (videoId: string): VideoExitAnalyticsResponseDto => {
